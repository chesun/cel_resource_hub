...
- The **one** exception stays firm: keeping confidential student data on Scribe and out of
  GitHub is a hard requirement, not a preference. `data-safety.md` and the tips index call this
  out explicitly so the softer voice around it doesn't dilute it.

## Consequences

- A reader can adopt or ignore any workflow without thinking they're breaking lab policy.
- The data-confidentiality rule is now clearly distinguished from style preferences.
